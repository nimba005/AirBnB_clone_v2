...
class DBStorage:
    ...
    def all(self, cls=None):
        """Query all objects for current session based on cladd name"""
        obj_dict = {}
    ...
    def reload(self):
        """Creates tables and current database session"""
        Base.metadata.create_all(self.__engine)
        session_factory = sessionmaker(bind=self.__engine, expired_on_commit=False)
